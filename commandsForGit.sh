...
# 1. Always pull new changes before you commit your changes to the web.
git pull;
...
# This is a little confusing because you have a LOCAL repository (when you instealled git), 
